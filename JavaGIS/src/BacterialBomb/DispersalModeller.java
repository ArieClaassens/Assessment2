 ...
 * <b>Overview:</b> The DispersalModeller class provides the framework for generating a dispersal pattern resulting from the
 * detonation of a biological warfare device. The pattern can be generated by importing a raster file containing the
...
public class DispersalModeller extends javax.swing.JFrame {
    ...
    public void RunModeller(Storage srcArray, String srcArrayName) {
        ...
        //Change to dynamic values via variables
        if ((xPos < 0) || (xPos > 300)) {
