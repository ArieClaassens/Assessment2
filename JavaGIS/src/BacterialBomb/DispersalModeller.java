...
/**
 * <b>Class:</b> DispersalModeller<br>
 * <b>Version:</b> 1.0 - 27 Dec 2014<br>
 * <b>Date:</b> 27 December 2014<br>
 * <b>Overview:</b> The DispersalModeller class provides the framework for generating a dispersal pattern resulting from
 * the detonation of a biological warfare device. The pattern can be generated by importing a raster file containing the
 * coordinates of the detonation point, or by using a randomly selected detonation point. Icons from
 * <a href="http://www.famfamfam.com/lab/icons/silk/" target="_blank">www.famfam.com</a>. Application icon example code from
 * <a href="http://java-demos.blogspot.in/2013/11/animate-icon-image-in-jframe.html" target="_blank">java-demos.blogspot.in</a>
 *
...
class DispersalModeller extends javax.swing.JFrame {
    ...
    //Instantiate new storage object to hold the dispersal map
    Storage storeDispersal = new Storage();
    //Instantiate new storage object to hold the random dispersal map
    ...
    //Set the labels to final so that they cannot be modified programmatically.
    private final Integer mouseOffsetX = 20;
    private final Integer mouseOffsetY = 120;

    //Label to define whether output should be converted from double to integer type when saving output
    private Boolean outputToInt = true;
    ...
    private Boolean sourceDataLoaded = false;
    ...
    /**
     * Method to remove all the tabs from the tabbed pane. Deletes all panes until the indexOfTab equals 0. Code
     * obtained from
     * <a href="http://stackoverflow.com/questions/1013479/after-calling-jtabbedpane-removeall-the-jtabbedpane-still-has-x-number-of-tab" target="_blank">stackoverflow.com</a>
     *
     * @param paneName The name of the jTabbedPane that must be cleaned up
     */
    ...
    /**
     * Method to enable the Run Modeller Menu Item and Button. Enables both the Menu Item and Button when called.
     */
    ...
    /**
     * Method to disable the Run Modeller Menu Item and Button. Disables both the Menu Item and Button when called.
     */
    ...
    public void setSliderValues() {
        ...
        if (jSliderTotalProbability.getValue() != 100) {
            ...
            jTextPaneMessages.setText("The total probability is 100% and thus correct.");
        }
    }

    /**
     * Method to run the Modeller on the supplied data object
     *
     * @param srcArray The data object used to store the particle dispersal pattern.
     * @param srcArrayName The name of the data object used to store the particle dispersal pattern. Used to determine
     * which map display method must be called, which in turn cleans up superfluous tabs and displays customized
     * content.
     */
    public void RunModeller(Storage srcArray, String srcArrayName) {
        ...
        if ((bacteriaCount > 0) && (xPos >= 0) && (xPos < srcArray.data.length) && (yPos >= 0)
            ...
            jTextPaneMessages.setText("Starting the modeller with valid parameters. Total probability at " + jSliderTotalProbability.getValue()
                    + ": North: " + changeNorthProbability + ", East: " + changeEastProbability
                    + ", South: " + changeSouthProbability + ", West: " + changeWestProbability + "Detonation at "
                    + detonationHeight + "m and particle count at " + bacteriaCount);
            ...
            //Additionally, utilise a popup window to call attention to the problem
            ...
            JOptionPane.showMessageDialog(this,
                    ...
                    + "Check that the detonation point falls inside the map area." + lineseparator
    ...
    /**
     * Method to display the Random Dispersal Map in a customized tab in the jTabbedPane
     */
    public void showRandomDispersalMap() {
        ...
        if (showRandomMap == true) {
            ...
            //Clean up any existing similarly named tabs to display only the latest random dispersal map
            ...
            //Switch focus to the new (last) tab
            ...
            //Activate the Save Random File Menu Item, as we have now satisfied the prerequisites
    ...
    public void showDispersalMap() {
        if (showDispersalMap == true) {
            ...
            //Generate and display the dispersal map
            //Draw the dispersal map in the tabbed pane
            ...
            //If the dispersal map tab already exists, remove it and display the latest dispersal map tab
    ...
    /**
     * Creates the new form DispersalModeller
     */
    ...
    private void initComponents() {
        ...
        jSliderNorthProbability.setToolTipText("Probability of particle moving in an NORTHERN direction");
        ...
        jSliderTotalProbability.setToolTipText("Total probability of particle moving in one of the four directions");
        ...
        jButtonRunRandomModeller.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTextFieldXPos, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextFieldStartHeight, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextFieldMouseY, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextFieldYPos, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    /**
     * Method to trigger the methods required to open the raster data source file.
     *
    ...
    private void jMenuOpenFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuOpenFileActionPerformed
        ...
        //Implement filtering for all platforms
        ...
        //Generate the detonation map and display it in the jTabbedPane
    ...
    /**
     * Method to trigger the methods required to save the raster data dispersal file.
     *
     * @param evt jMenu event trigger that fires off the action.
     */
    ...
    /**
     * Method to trigger the methods required to run the Modeller.
     *
     * @param evt jMenu event trigger that fires off the action.
     */
    ...
    private void jMenuHelpModellerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuHelpModellerActionPerformed
        ...
        //Instantiate a new HTMLhelp class, which opens the pop-up window, consisting of a jFrame with a jEditorPane
        //into which the HTML content is loaded in read-only mode.
